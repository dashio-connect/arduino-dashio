...
void processConfig() {
  ...
  Serial.println(myBLEconnection.idStr + "mm");
  Serial.print(F("Screen height: "));
  Serial.println(myBLEconnection.payloadStr + "mm");

  bleWriteStr(myDevice.getConfigMessage(DeviceCfg(2))); // Two pages
